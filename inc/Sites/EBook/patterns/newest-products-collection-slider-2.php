<?php
/**
 * Title: Brandy newest products collection with slider layout 2
 * Slug: brandy/newest-products-collection-slider-layout-2
 * Categories: brandy
 */
...
<!-- wp:woocommerce/product-collection {"metadata":{"categories":["brandy"],"patternName":"brandy/newest-products-collection-slider-layout-2","name":"Brandy Newest Products Collection With Slider Layout 2"},"queryId":10,"query":{"perPage":<?php echo esc_attr( apply_filters( 'brandy_products_collection_per_page', 8 ) ); ?>,"pages":1,"offset":0,"postType":"product","order":"desc","orderBy":"date","search":"","exclude":[],"inherit":false,"taxQuery":{<?php echo wp_kses_post( \brandy_get_products_collection_demo_tax_queries() ); ?>},"isProductCollectionBlock":true,"featured":false,"woocommerceOnSale":false,"woocommerceStockStatus":["instock","outofstock","onbackorder"],"woocommerceAttributes":[],"woocommerceHandPickedProducts":[],"timeFrame":{"operator":"in","value":"-7 days"}},"tagName":"div","displayLayout":{"type":"flex","columns":<?php echo esc_attr( apply_filters( 'brandy_products_collection_column', 4 ) ); ?>,"shrinkColumns":true},"collection":"woocommerce/product-collection/new-arrivals","hideControls":["inherit","order"],"queryContextIncludes":["collection"],"align":"wide", "className":"brandy-product-collection-slider"} -->

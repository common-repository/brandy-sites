<?php
/**
 * Title: Brandy Checkout Processing Bar
 * Slug: brandy/checkout-processing-bar
 * Categories: brandy
 */
?>

<!-- wp:group {"metadata":{"categories":["brandy"],"patternName":"brandy/checkout-processing-bar","name":"Brandy Checkout Processing Bar"},"className":"brandy-processing-bar","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
...
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"#fefefe"}}},"typography":{"fontStyle":"normal","fontWeight":"600"},"color":{"text":"#fefefe"}},"fontSize":"large-to-small"} -->
...
<div class="wp-block-group"><!-- wp:buttons {"style":{"layout":{"selfStretch":"fixed","flexSize":"30px"}}} -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"border":{"radius":"100px"},"spacing":{"padding":{"left":"11px","right":"11px","top":"5px","bottom":"5px"}},"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"large-to-small"} -->
<div class="wp-block-button has-custom-font-size has-large-to-small-font-size" style="font-style:normal;font-weight:700"><a class="wp-block-button__link wp-element-button" href="#" style="border-radius:100px;padding-top:5px;padding-right:11px;padding-bottom:5px;padding-left:11px"><strong>2</strong></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|brandy-accent"}}},"typography":{"fontStyle":"normal","fontWeight":"600"}},"textColor":"brandy-accent","fontSize":"large-to-small"} -->
<p class="has-brandy-accent-color has-text-color has-link-color has-large-to-small-font-size" style="font-style:normal;font-weight:600"><?php echo esc_html__( 'Shipping detail', 'brandy-sites' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

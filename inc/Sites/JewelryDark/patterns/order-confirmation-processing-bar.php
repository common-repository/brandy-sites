...
<!-- wp:group {"metadata":{"categories":["brandy"],"patternName":"brandy/order-confirmation-processing-bar","name":"Brandy Order Confirmation Processing Bar"},"className":"brandy-processing-bar","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
...
<div class="wp-block-group"><!-- wp:buttons {"style":{"layout":{"selfStretch":"fixed","flexSize":"30px"}}} -->
<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"brandy-accent","textColor":"white","style":{"border":{"radius":"100px"},"spacing":{"padding":{"left":"10px","right":"10px","top":"5px","bottom":"5px"}},"typography":{"fontStyle":"normal","fontWeight":"700"},"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"fontSize":"large-to-small"} -->

<?php
/**
 * Title: Brandy Single Simple Featured Product ( Gallery Images )
 * Slug: brandy/single-featured-product-with-gallery
...
<!-- wp:woocommerce/single-product {"metadata":{"categories":["brandy"],"patternName":"brandy/single-featured-product-with-gallery","name":"Brandy Single Simple Featured Product ( Gallery Images )"},"productId":<?php echo esc_html( $product_id ); ?>,"align":"wide","className":"brandy-single-featured-product brandy-single-simple-featured-product"} -->
<div
